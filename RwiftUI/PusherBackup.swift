...
//import PusherSwift
//
////re-write AuthRequestBuilder to match with other code.
////class AuthRequestBuilder: AuthRequestBuilderProtocol {
////
////    func requestFor(socketID: String, channelName: String) -> URLRequest? {
////
////        var authEndpoint = "\(_gateWayHRurl)/\(_companyName)/websocket/auth";
////
////        var urlRequest = URLRequest(url: URL(string: authEndpoint)!)
////
////        urlRequest.httpMethod = "POST"
////        urlRequest.httpBody = "socket_id=\(socketID)&channel_name=\(channelName)".data(using: String.Encoding.utf8)
////        urlRequest.addValue("application/json", forHTTPHeaderField: "Accept")
////        urlRequest.addValue(stateData.shared.getBearerToken(), forHTTPHeaderField: "Authorization")
////
////        print(urlRequest.httpBody)
////        print(urlRequest.logDetails())
////
////        return urlRequest
////    }
////}
...
////    private let _gateWayHRurl = "https://uat-api-hr.bamawl.com/api"
////    private let _companyNameKey = "company_code"
////
////    func realtimeAPI() -> AnyPublisher<WebSocketData, Error> { //Cannot find type 'WebSocketData' in scope
////        guard let companyName = UserDefaults.standard.string(forKey: _companyNameKey) else {
////            // If company_code is not found, return a Fail publisher
////            return Fail(error: APIError.invalidCompanyCode).eraseToAnyPublisher()
////        }
////
////        let url = "\(_gateWayHRurl)/\(companyName)/websocket/setting"
////
////        return fetch(url: url, method: .get)
////            .tryMap { (response: WebSocketSetting) -> WebSocketData in
////                if response.status != "NG", let data = response.data { //Initializer for conditional binding must have Optional type, not 'WebSocketData'
////                    return data
////                } else {
////                    let errorMessage = response.status == "NG" ? (response.status ?? "Unknown error") : "Data not found by realtime api"
////                    throw APIError.customError(message: errorMessage)
////                }
////            }
////            .eraseToAnyPublisher()
////    }
...
//
//    // Replace with your actual base URL constants
//    //private let _pusherDomain = "your_pusher_domain.com" // Example: "ws.example.com"
